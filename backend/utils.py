...
def generate_recommendation(
    ...
    midsemester_norm = midsemester / 15.0
    assignment_norm = assignment / 10.0
    quiz_norm = quiz / 5.0

    norms = {
        "attendance": attendance_norm,
        "midsemester exam": midsemester_norm,
    ...
    elif weakest_component == "midsemester exam":
        weakness_advice = "Your midsemester exam score is your lowest CA component. Focus on reviewing lecture slides and tutorial questions."
...
def predict_course_performance(
    ...
    # 2. Compute CA Score
    ca_score = calculate_ca_score(attendance, midsemester_score, assignment_score, quiz_score)
