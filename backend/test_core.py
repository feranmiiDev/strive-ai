...
def run_tests():
    ...
    # course difficulty 1 (Easy), 3 credit units, 90% attendance, midsemester score 13/15,
    ...
    # course difficulty 3 (Hard), 4 credit units, 60% attendance, midsemester score 5/15,
