...
* **Midsemester ($M$)**: $0 \le M \le 15$ marks
...
After removing the historical academic score (`previous_scores`) from the feature set, the models were retrained on a synthetic student dataset (augmented with SMOTE to balance the risk classifications). The performance metrics are documented below:

### 1. Regression Performance (Final Mark Prediction)
* **XGBoost Regressor**: MAE = **4.47**, $R^2$ = **0.8939** ($89.39\%$ variance explained)
* **Random Forest Regressor**: MAE = **4.47**, $R^2$ = **0.8913** ($89.13\%$ variance explained)

### 2. Classification Performance (Academic Risk Level)
* **XGBoost Classifier**: Validation Accuracy = **81.00%** (Precision: $0.86$, Recall: $0.85$ for *High Risk* students)
* **Random Forest Classifier**: Validation Accuracy = **79.00%** (Precision: $0.84$, Recall: $0.83$ for *High Risk* students)

For the visual feature importance plots, confusion matrix heatmaps, and regression comparison charts, refer to the saved PNG assets inside the [model/](file:///C:/Users/pscar/Documents/400l%20First%20Sem%20study%20folder/FYP/design%20and%20implementation/main/model/) directory:
* [strive_ai_feature_importance.png](file:///C:/Users/pscar/Documents/400l%20First%20Sem%20study%20folder/FYP/design%20and%20implementation/main/model/strive_ai_feature_importance.png)
* [strive_ai_confusion_matrix.png](file:///C:/Users/pscar/Documents/400l%20First%20Sem%20study%20folder/FYP/design%20and%20implementation/main/model/strive_ai_confusion_matrix.png)
* [strive_ai_regression_comparison.png](file:///C:/Users/pscar/Documents/400l%20First%20Sem%20study%20folder/FYP/design%20and%20implementation/main/model/strive_ai_regression_comparison.png)
...
CREATE TABLE public.academic_records (
    ...
    midsemester_score NUMERIC NOT NULL,
